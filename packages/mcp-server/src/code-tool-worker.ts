...
const fuse = new Fuse(
  [
    ...
    'client.authors.delete',
    'client.authors.list',
    'client.authors.retrieve',
    'client.authors.update',
    'client.queue.getStats',
    'client.queue.retrieve',
    'client.queue.items.list',
    'client.queue.items.resolve',
    'client.queue.items.unresolve',
    'client.actions.create',
    'client.actions.delete',
    'client.actions.list',
    'client.actions.retrieve',
    'client.actions.update',
    'client.actions.execute.execute',
    'client.actions.execute.executeByID',
    'client.content.submit',
    'client.account.list',
    'client.auth.create',
    'client.auth.retrieve',
    'client.wordlist.getEmbeddingStatus',
    'client.wordlist.list',
    'client.wordlist.retrieve',
    'client.wordlist.update',
    'client.wordlist.words.add',
    'client.wordlist.words.remove',
  ],
