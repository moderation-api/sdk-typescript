...
import { Account, AccountListResponse } from './resources/account';
import { Auth, AuthCreateParams, AuthCreateResponse, AuthRetrieveResponse } from './resources/auth';
import {
  AuthorCreateParams,
...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['MODERATION_API_BASE_URL'].
   */
...
export class ModerationAPI {
  ...
  constructor({
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('MODERATION_API_LOG'), "process.env['MODERATION_API_LOG']", this) ??
      defaultLogLevel;
    ...
    const customHeadersEnv = readEnv('MODERATION_API_CUSTOM_HEADERS');
    if (customHeadersEnv) {
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://api.moderationapi.com/v1';
  }
  ...
  static ModerationAPI = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static ModerationAPIError = Errors.ModerationAPIError;
