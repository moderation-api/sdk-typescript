...
describe('resource content', () => {
  ...
  test.skip('stream: only required params', async () => {
    const responsePromise = client.content.stream({ 'Sec-WebSocket-Protocol': 'moderationapi.v1' });
  ...
  test.skip('stream: required and optional params', async () => {
    const response = await client.content.stream({ 'Sec-WebSocket-Protocol': 'moderationapi.v1' });
  });
