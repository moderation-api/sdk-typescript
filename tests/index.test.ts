...
import { APIPromise } from '@moderation-api/sdk/core/api-promise';

import util from 'node:util';
import ModerationAPI from '@moderation-api/sdk';
import { APIUserAbortError } from '@moderation-api/sdk';
...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    ...
    beforeEach(() => {
      process.env = { ...env };
      process.env['MODERATION_API_LOG'] = undefined;
    });
    ...
    const forceAPIResponseForClient = async (client: ModerationAPI) => {
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['MODERATION_API_BASE_URL'] = undefined;
    });
